...
/*   Updated: 2021/12/21 17:27:33 by ahel-mou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	up(t_unit *vr3)
{
	...
	if (vr3->td_map[vr3->p_y / 30 - 1][vr3->p_x / 30] != '1'
			&& vr3->td_map[vr3->p_y / 30 - 1][vr3->p_x / 30] != 'E')
	{
		vr3->p_y -= 30;
		vr3->img = mlx_xpm_file_to_image(vr3->init, mv.src,
				&mv.x_img, &mv.y_img);
		render_player(vr3, &mv);
	}
	else if (vr3->td_map[vr3->p_y / 30 - 1][vr3->p_x / 30] != '1'
				&& vr3->unlock == 1)
	{
		vr3->p_y -= 30;
		vr3->img = mlx_xpm_file_to_image(vr3->init, mv.src,
...
void	right(t_unit *vr3)
{
	...
	if (vr3->td_map[vr3->p_y / 30][vr3->p_x / 30 + 1] != '1'
			&& vr3->td_map[vr3->p_y / 30][vr3->p_x / 30 + 1] != 'E')
	{
		vr3->p_x += 30;
		vr3->img = mlx_xpm_file_to_image(vr3->init, mv.src,
				&mv.x_img, &mv.y_img);
	...
	else if (vr3->td_map[vr3->p_y / 30][vr3->p_x / 30 + 1] != '1'
			&& vr3->unlock == 1)
	{
		vr3->p_x += 30;
		vr3->img = mlx_xpm_file_to_image(vr3->init, mv.src,
