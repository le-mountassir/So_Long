...
#    Updated: 2021/12/21 18:14:14 by ahel-mou         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
b : $(b_OBJ) 
	...
	@ar -rcs $(NAME) $(b_OBJ)
	$(CC) ./bonus/so_long.c -lmlx -framework OpenGL -framework AppKit $(NAME) -o minecrap_bonus

m : $(m_OBJ) 
	@$(CC) -c $(FLAGS) $(mand_SRC)
	@ar -rcs $(NAME) $(m_OBJ)
	$(CC) ./mand/so_long.c -lmlx -framework OpenGL -framework AppKit $(NAME) -o minecrap_mand
